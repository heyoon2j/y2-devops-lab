...
ACCOUNT_ARN_PATH="/home/zabbix/config/account.yaml"
...
def main():
    ...
    # 파일 정보 가져오기
    accountNames = {}
    with open(ACCOUNT_ARN_PATH, encoding='UTF-8') as f:
        accountNames = yaml.load(f, Loader=yaml.FullLoader)
    ...
    for roleArn in roleArns.values():
        ...
        for reservation in reservations:
            for instance in reservation["Instances"]:      
                ...
                print(hostName, ipAddress, account, vCpu, memory, volume)

                assets.append(CustomAssetsDO(hostName=hostName, ipAddress=ipAddress, account=account, instanceType=instanceType, vCpu=vCpu, memory=memory, volume=volume))
