...
resource "aws_networkfirewall_firewall" "nfw_firewall" {
    ...
    delete_protection = var.firewall["firewall_policy_arn"]
...
resource "aws_networkfirewall_firewall_policy" "nfw_fw_policy_default" {
    ...
    firewall_policy {
        policy_variables = var.firewall_policy["policy_variables"]
    ...
    tags = var.firewall_policy["tagws"]
}
...
resource "aws_networkfirewall_logging_configuration" "nfw_log_config" {
    count = var.firewall["logging_configuration"] ? 1 : 0
