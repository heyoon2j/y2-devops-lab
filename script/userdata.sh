...
sudo sed -i 's/ssh_pwauth:\s*0\s*/ssh_pwauth:   1/' /etc/cloud/cloud.cfg

sudo sed -i 's/ssh_pwauth:\s*false\s*/ssh_pwauth:   true/' /etc/cloud/cloud.cfg
...
echo 'sysadmin:k@reanre12!' | chpasswd
